...
public class TestServiceImpl implements TestService {
	...
	public TestServiceImpl(CartDAO cartDAO, ContactsDAO contactsDAO, DistilleryDAO distilleryDAO, OrderDAO orderDAO, ProductDAO productDAO, 
			RegionDAO regionDAO, UserAccountDAO userAccountDAO) {
